...
var rsPR='<img src="https://web.archive.org/web/20050629073549/http://server-au.imrworldwide.com/cgi-bin/count?url='+pUrl+'&rnd='+(new Date()).getTime()+'&cid='+pCid+'&ref='+refR+'&sr=sr'+rsSW+'x'+rsSH+':cd'+rsCD+':lg'+rsLG+':je'+rsJE+':ck'+rsCK+':tz'+rsTZ+':ct'+rsCT+':hp'+rsHP+'" width=1 height=1>';
...
rsPR='<applet code="Measure.class" codebase="https://web.archive.org/web/20050629073549/http://server-au.imrworldwide.com/" width=1 height=2>'+pUrl+pCid+RSsr+'<param name="ref" value="'+refR+'"></applet>';}
...
/*
     FILE ARCHIVED ON 07:35:49 Jun 29, 2005 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 09:29:24 Jan 17, 2024.
...
/*
playback timings (ms):
  captures_list: 189.127
  exclusion.robots: 0.06
  exclusion.robots.policy: 0.053
  cdx.remote: 0.05
  esindex: 0.008
  LoadShardBlock: 66.36 (3)
  PetaboxLoader3.datanode: 194.233 (4)
  load_resource: 175.493
  PetaboxLoader3.resolve: 37.491
*/